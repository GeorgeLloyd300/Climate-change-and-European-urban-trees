...
save(master_1, file = "master_1.Rdata", compress = F)
...
# subset caceres
caceres<-subset(master_2, city.name == "Caceres") 
...
master_4.no.height<-subset(master_4,city.name == "Bristol"| city.name == "Hamburg"| city.name == "Oslo"|city.name == "Girona")
