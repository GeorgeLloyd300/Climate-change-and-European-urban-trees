...
write.csv(combined.means, "combined.means.98.csv")
...
margin 2070 (°C)")+ scale_x_continuous(limits = c(-9, 9), expand = c(0, 0), breaks = c(-10, -5, 0, 5, 10), labels = c("10 margin", "5 margin", "0", "5 gap", "10 gap")) +
  scale_y_continuous(limits = c(-48,27), expand = c(0, 0), breaks = c( -20, 0, 20, 40), labels = c( "20 margin", "0", "20 gap","40 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-9), xmax=c(0), ymin=c(-48) , ymax=c(0), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(-9), xmax=c(0), ymin=c(0) , ymax=c(27), alpha=0.5, fill="orange")+  # make coloured rectangles
  annotate("rect", xmin=c(0), xmax=c(9), ymin=c(-48) , ymax=c(0), alpha=0.5, fill="orange")+
  annotate("rect", xmin=c(0), xmax=c(9), ymin=c(0) , ymax=c(27), alpha=0.6, fill="red")+
  ...
  annotate("text", x = 5, y = -43, size=5, label  = "40.15%±38.11")+
  annotate("text", x = -5, y = 20, size=5, label  = "1.19%±2.35")+
  annotate("text", x = 5, y = 20, size=5, label   = "5.96%±10.53")+
  annotate("text", x = -5, y = -43, size=5, label = "52.66%±40.44 ") + theme(legend.position = "none") 
a
...
total carbon",labels = c("0.1", "1", "5","10"))+
  facet_grid(.~title)+
  labs(y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)")+ scale_x_continuous(limits = c(-10, 8), expand = c(0, 0), breaks = c(-10, -5, 0, 5), labels = c("10 margin","5 margin", "0", "5 gap")) +
  scale_y_continuous(limits = c(-45,17.5), expand = c(0, 0), breaks = c(-25, -12.5, 0, 12.5), labels = c("25 margin","12.5 margin", "0", "12.5 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-10), xmax=c(0), ymin=c(-45) , ymax=c(0), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(-10), xmax=c(0), ymin=c(0) , ymax=c(17.5), alpha=0.5, fill="orange")+  
  annotate("rect", xmin=c(0), xmax=c(8), ymin=c(-45) , ymax=c(0), alpha=0.5, fill="orange")+ 
  annotate("rect", xmin=c(0), xmax=c(8), ymin=c(0) , ymax=c(17.5), alpha=0.6, fill="red")+
  theme(legend.text = element_text(size = 13),legend.title = element_text(size=13),
        axis.text.y = element_text(size = 14), legend.margin=margin(0, 0, 0, -4), 
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14), strip.text.x = element_text(size=18))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = -6, y = -7, size=5, label  = "66.61%±36.86")+ 
  annotate("text", x = -6, y = 7, size=5, label  = "0%±0")+
  annotate("text", x = 4, y = -7, size=5, label  = "33.27%±36.85")+
  annotate("text", x = 4, y = 7, size=5, label  = "0.01±0.02")
aa
...
storage (tonnes)")+ scale_x_continuous(limits = c(-8, 9), expand = c(-0, -0), breaks = c(-10, -5,0, 5, 10), labels = c("10 margin","5 margin", "0", "5 gap", "10 gap")) +
  scale_y_continuous(limits = c(-16,21), expand = c(0, 0), breaks = c(-20, -10, 0, 10, 20,30), labels = c("20 margin","10 margin","0", "10 gap", "20 gap", "30 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-8), xmax=c(0), ymin=c(0) , ymax=c(-16), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(0), xmax=c(9), ymin=c(-16) , ymax=c(0), alpha=0.5, fill="orange")+  # make coloured rectangles
  annotate("rect", xmin=c(-8), xmax=c(0), ymin=c(0) , ymax=c(21), alpha=0.5, fill="orange")+
  annotate("rect", xmin=c(0), xmax=c(9), ymin=c(0) , ymax=c(21), alpha=0.6, fill="red")+
  theme(legend.text = element_text(size = 13), legend.title = element_text(size = 13), 
        legend.margin=margin(0, 0, 0, -4),axis.text.y = element_text(size = 14), 
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14),strip.text.x = element_text(size=18))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = 6.5, y = -7, size=5, label  = "18.68%±NA")+
  annotate("text", x = -5, y = 15, size=5, label  = "0.83%±NA")+
  annotate("text", x = -5, y = -7, size=5, label   = "65.99%±NA")+
  annotate("text", x = 6.5, y = 3, size=5, label = "14.50%±NA")+ theme(legend.position = "none") 
b
...
total carbon", labels = c("0.1","1", "5", "10", "15"))+
  ...
  labs( y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-10, 10), expand = c(-0, -0), breaks = c(-5, 0, 5), labels = c("5 margin", "0", "5 gap")) +
  scale_y_continuous(limits = c(-17, 11), expand = c(0, 0), breaks = c(-20, -10, 0, 10, 20), labels = c("20 margin", "   10 margin", "0", "10 gap", "20 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+ 
  annotate("rect", xmin=c(-10), xmax=c(0), ymin=c(-17) , ymax=c(0), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(-10), xmax=c(0), ymin=c(0) , ymax=c(11), alpha=0.5, fill="orange")+ 
  annotate("rect", xmin=c(0), xmax=c(10), ymin=c(-17) , ymax=c(0), alpha=0.5, fill="orange")+
  annotate("rect", xmin=c(0), xmax=c(10), ymin=c(0) , ymax=c(11), alpha=0.6, fill="red")+
  theme(legend.text = element_text(size = 13), legend.title = element_text(size = 13), 
        legend.margin=margin(0, 0, 0, -4),axis.text.y = element_text(size = 14), 
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14),strip.text.x = element_text(size=18))+
  ...
  annotate("text", x = 5, y = -5, size=5, label  = "27.57%±NA")+ 
  annotate("text", x = 5, y = 5, size=5, label  = "0.01%±NA")+ 
  annotate("text", x = -5, y = -5, size=5, label  = "72.47%±NA")
...
c<-ggplot(Dfb.prec, aes(x=temp.margin, y=safety.margin.2070, size =carbon))+
  ...
  labs( y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-8.5, 11), expand = c(-0, -0), breaks = c(-10,-5, 0, 5, 10),labels = c("10 margin", "5 margin","0", "5 gap", "10 gap")) +
  scale_y_continuous(limits = c(-34, 20), expand = c(0, 0), breaks = c(-30,0, 30, 45),labels = c("30 margin",  "0", "30 gap", "45 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-8.5), xmax=c(0), ymin=c(-34) , ymax=c(0), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(0), xmax=c(11), ymin=c(-34) , ymax=c(0), alpha=0.5, fill="orange")+  
  annotate("rect", xmin=c(-8.5), xmax=c(0), ymin=c(0) , ymax=c(20), alpha=0.5, fill="orange")+
  annotate("rect", xmin=c(0), xmax=c(11), ymin=c(0) , ymax=c(20), alpha=0.6, fill="red")+ # make coloured rectangles
  theme(legend.text = element_text(size = 13), legend.title = element_text(size = 13), 
        legend.margin=margin(0, 0, 0, -4),axis.text.y = element_text(size = 14),
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14), strip.text.x = element_text(size=18))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = 7, y = -30, size=5, label  = "35.21%±30.18")+
  annotate("text", x = -4, y = 16, size=5, label  = "0.63%±0.99")+
  annotate("text", x = 7, y = 16, size=5, label   = "12.31%±12.44")+
  annotate("text", x = -4, y = -30, size=5, label = "51.85%±43.50") +
...
cc<-ggplot(Dfb.prec, aes(x=temp.margin, y=safety.margin.2070, size =carbon))+
  geom_point(alpha =0.7)+ scale_size_continuous(breaks = c(0.001, 0.1, 1, 5, 10, 15), range = c(0.75, 20) , name = "Percentage of 
total carbon", labels = c("0.001","0.1","1", "5", "10", "15"))+
  theme(plot.title = element_text(hjust = 0.5, size =12, face= "bold"))+
  facet_grid(. ~ title)+
  labs( y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-10, 10), expand = c(-0, -0), breaks = c(-20,-15, -5, 0, 5),labels = c("15 margin","10 margin", "5 margin", "0", "5 gap")) +
  scale_y_continuous(limits = c(-35, -9), expand = c(0, 0), breaks = c(-30,-20, -10),labels = c("30 margin", "   20 margin", "10 margin"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-10), xmax=c(0), ymin=c(-35) , ymax=c(-9), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(0), xmax=c(10), ymin=c(-35) , ymax=c(-9), alpha=0.5, fill="orange")+  
  theme(legend.text = element_text(size = 13), legend.title = element_text(size = 13), 
        legend.margin=margin(0, 0, 0, -4),axis.text.y = element_text(size = 14),
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14), strip.text.x = element_text(size=18))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = -5, y = -17, size=5, label  = "38.13%±26.49")+
  annotate("text", x =5, y = -17, size=5, label  = "68.17%±31.63")+
...
d<-ggplot(Cfa.prec, aes(x=temp.margin, y=safety.margin.2070, size =carbon))+
  ...
  labs(y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-7, 14), expand = c(-0, -0), breaks = c(-5,0,5,10),labels = c("5 margin", "0", "5 gap", "10 gap")) +
  scale_y_continuous(limits = c(-39,22), expand = c(0, 0), breaks = c(-30,-15, 0,15),labels = c("30 margin", "15 margin", "0", "15 gap"))+ theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-7), xmax=c(0), ymin=c(0) , ymax=c(-39), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(0), xmax=c(14), ymin=c(-39) , ymax=c(0), alpha=0.5, fill="orange")+  # make coloured rectangles
  annotate("rect", xmin=c(-7), xmax=c(0), ymin=c(0) , ymax=c(22), alpha=0.5, fill="orange")+
  annotate("rect", xmin=c(0), xmax=c(14), ymin=c(0) , ymax=c(22), alpha=0.6, fill="red")+
  theme(legend.text = element_text(size = 13),legend.title = element_text(size = 13),
  ...
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = 10.5, y = -30, size=5, label  = "71.69%±1.33")+
  annotate("text", x = -4, y = 18, size=5, label  = "1.96%±3.39")+
  annotate("text", x = 10.5, y = 18, size=5, label   = "21.52%±12.24")+
  annotate("text", x = -3.7, y = -30, size=5, label = "4.83%±8.23") +
  theme(legend.key.size = unit(0.5,"point"))+ theme(legend.position = "none")    
d
...
total carbon", labels = c("0.1","1", "5", "10", "15"))+
  ...
  labs(y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-8, 13), expand = c(-0, -0), breaks = c(-5,0,5,10),labels = c("5 margin", "0","5 gap", "10 gap")) +
  scale_y_continuous(limits = c(-35,4.5), expand = c(0, 0), breaks = c(-30,-15, 0),labels = c("   30 margin", "15 margin", "0"))+ theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-8), xmax=c(0), ymin=c(-35) , ymax=c(0), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(-8), xmax=c(0), ymin=c(0) , ymax=c(4.5), alpha=0.5, fill="orange")+  # make coloured rectangles
  annotate("rect", xmin=c(0), xmax=c(13), ymin=c(-35) , ymax=c(0), alpha=0.5, fill="orange")+  
  annotate("rect", xmin=c(0), xmax=c(13), ymin=c(0) , ymax=c(4.5), alpha=0.6, fill="red")+  
  theme(legend.text = element_text(size = 13),legend.title = element_text(size = 13),
        plot.margin = unit( c(1,0,0.8,0), "in"), legend.margin=margin(0, 0, 0, -4),
        strip.text.x = element_text(size=18), 
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.y = element_text(size=14), axis.text.x = element_text(size = 14))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = 6, y = -10, size=5, label  = "82.46%±19.67")+
  annotate("text", x = -4, y = 2, size=5, label  = "0%±0")+
  annotate("text", x = 6, y = 2, size=5, label  = "0.14%±0.24")+
  annotate("text", x = -4, y = -10, size=5, label  = "17.40%±19.44")+
  theme(legend.key.size = unit(0.5,"point"))  
dd
...
e<-ggplot(Dsk.prec, aes(x=temp.margin, y=safety.margin.2070, size =carbon))+
  ...
  labs( y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-2, 16), expand = c(-0, -0), breaks = c(0,10),labels = c("0","10 gap")) +
  scale_y_continuous(limits = c(-12, 35), expand = c(0, 0), breaks = c(-15,0,15, 30),labels = c("15 margin", "0", "     15 gap", "30 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-2), xmax=c(0), ymin=c(0) , ymax=c(-12), alpha=0.5, fill="#66CC00")+
  annotate("rect", xmin=c(0), xmax=c(16), ymin=c(-12) , ymax=c(0), alpha=0.5, fill="orange")+  
  annotate("rect", xmin=c(-2), xmax=c(0), ymin=c(0) , ymax=c(35), alpha=0.5, fill="orange")+
  annotate("rect", xmin=c(0), xmax=c(16), ymin=c(0) , ymax=c(35), alpha=0.6, fill="red")+ # make coloured rectangles
  theme(legend.text = element_text(size = 13), legend.title = element_text(size = 13), 
        legend.margin=margin(0, 0, 0, -4),axis.text.y = element_text(size = 14),
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14), strip.text.x = element_text(size=18))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = 13, y = -4, size=5, label  = "46.19%±15.33")+
  annotate("text", x = -0.5, y = 4, size=5, label  = "0%±0")+
  annotate("text", x = 13, y = 4, size=5, label   = "53.79%±15.34")+
  annotate("text", x = 0.6, y = -4, size=5, label = "0.02%±0.01") +
  theme(legend.key.size = unit(0.5,"point"))+ theme(legend.position = "none")    
e
...
total carbon", labels = c("0.1","1", "5", "10", "15"))+
  ...
  labs( y="Hydraulic safety 2070 (mm)", x= "Thermal safety 2070 (°C)", colour="Thermal safety 
margin 2070 (°C)", size = "Current carbon
storage (tonnes)")+ scale_x_continuous(limits = c(-4, 14), expand = c(-0, -0), breaks = c(-5, 0, 5, 10, 15),labels = c("5 margin", "0","5 gap", "10 gap", "15 gap")) +
  scale_y_continuous(limits = c(-9, 11), expand = c(0, 0), breaks = c(-5,0, 5, 10),labels = c("    5 margin", "0", "5 gap", "10 gap"))+theme_bw()+
  theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+
  theme(plot.title = element_text(hjust = 0.5, size =18, face= "bold"))+
  theme(text = element_text(size = 15))+
  annotate("rect", xmin=c(-4), xmax=c(0), ymin=c(-9) , ymax=c(0), alpha=0.5, fill="#66CC00")+  
  annotate("rect", xmin=c(-4), xmax=c(0), ymin=c(0) , ymax=c(11), alpha=0.5, fill="orange")+  
  annotate("rect", xmin=c(0), xmax=c(14), ymin=c(-9) , ymax=c(0), alpha=0.5, fill="orange")+  
  annotate("rect", xmin=c(0), xmax=c(14), ymin=c(0) , ymax=c(11), alpha=0.6, fill="red")+  
  theme(legend.text = element_text(size = 13), legend.title = element_text(size = 13), 
        legend.margin=margin(0, 0, 0, -4),axis.text.y = element_text(size = 14),
        axis.title.y = element_blank(),axis.title.x = element_blank(),
        axis.text.x = element_text(size = 14), strip.text.x = element_text(size=18))+
  theme(plot.margin=grid::unit(c(2,2,2,2), "mm"))+
  annotate("text", x = 11.1, y = -7.5, size=5, label  = "99.16%±0.98")+
  annotate("text", x = -2, y = 5, size=5, label  = "0%±0")+
  annotate("text", x = 7, y = 5, size=5, label  = "0.80%±0.97")+
  annotate("text", x = -1.3, y = -2, size=5, label  = "0.02%±0.01")+
  theme(legend.key.size = unit(0.5,"point"))
ee
